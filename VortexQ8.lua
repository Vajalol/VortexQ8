SLASH_VORTEXQ8RESET1 = "/vortexq8-reset"
SlashCmdList.VORTEXQ8RESET = function()
    SetCVar("uiScale", 1.0)
    UIParent:SetScale(1.0)
end

SLASH_VORTEXQ81 = "/vortexq8"
SlashCmdList.VORTEXQ8 = function()
    -- MainFrame
    local UIConfig = CreateFrame("Frame", "VortexQ8Scale", UIParent, "BasicFrameTemplateWithInset")
    ...
    UIConfig.title:SetText("VortexQ8 UI Scaler Options")
    ...
    -- Save Button
    UIConfig.autoButton = CreateFrame("Button", nil, UIConfig, "GameMenuButtonTemplate")
